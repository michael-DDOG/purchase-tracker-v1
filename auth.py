...
# Default PIN for development; override via AUTH_PIN env var
DEFAULT_PIN = "1234"
...
def _get_secret() -> str:
    ...
    if not secret:
        # Generate a stable secret from AUTH_PIN so tokens survive restarts
        pin = os.getenv("AUTH_PIN") or os.getenv("APP_PIN", DEFAULT_PIN)
...
def verify_pin(pin: str) -> bool:
    """
    Check PIN against AUTH_PIN env var.
    ...
    expected_pin = os.getenv("AUTH_PIN") or os.getenv("APP_PIN", DEFAULT_PIN)
